for i,v in pairs(game:GetService("CoreGui"):GetChildren()) do
    if v:IsA("ScreenGui") and v.Name == "OmniHub" then
        v:Destroy()
    end
end
...
wait(.6)
Barload:TweenSize(UDim2.new(0, 5,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
LoadText.Text = "Hello, ".. game.Players.LocalPlayer.Name.. "!"
wait(1)
LoadText.Text = "Thank you for purchasing OmniHub!"
wait(1)
LoadText.Text = "Detecting game compatability.."
wait(1)
LoadText.Text = "Game Supported, " .._G.gametxt
wait(1)
LoadText.Text = "Loading the gui now."
wait(1)
LoadText.Text = "Loading the scripts.."
wait(math.random(0.5, 1))
Barload:TweenSize(UDim2.new(0, 10,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
LoadText.Text = "Finished Loading the Scripts!"
wait(math.random(0.5, 1))
LoadText.Text = "Loading the Labels.."
wait(math.random(0.5, 1))
Barload:TweenSize(UDim2.new(0, 20,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
LoadText.Text = "Finished Loading the Labels!"
wait(math.random(0.5, 1))
LoadText.Text = "Loading the Buttons..."
wait(math.random(0.5, 1))
Barload:TweenSize(UDim2.new(0, 50,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
LoadText.Text = "Finished Loading the Buttons!"
wait(math.random(0.5, 1))
LoadText.Text = "Loading the Dropdowns..."
wait(math.random(0.5, 1))
Barload:TweenSize(UDim2.new(0, 75,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
LoadText.Text = "Finished Loading Dropdowns!"
wait(math.random(0.5, 1))
LoadText.Text = "Loading the Toggles.."
wait(math.random(0.5, 1))
Barload:TweenSize(UDim2.new(0, 150,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
LoadText.Text = "Finished Loading the Toggles.."
wait(math.random(0.5, 1))
LoadText.Text = "Loading the functions.."
wait(math.random(0.5, 1))
Barload:TweenSize(UDim2.new(0, 200,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
LoadText.Text = "Finished Loading the functions!"
wait(math.random(0.5, 1))
LoadText.Text = "Peforming Final Tests..."
Barload:TweenSize(UDim2.new(0, 250,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true) 
wait(math.random(0.5, 1))
LoadText.Text = "Finished Peforming The Final Tests.."
wait(math.random(0.5, 1))
LoadText.Text = "Loading The gui now"
wait(1)
